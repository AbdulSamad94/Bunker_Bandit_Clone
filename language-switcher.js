document.addEventListener("DOMContentLoaded", function () {
  ...
  const translations = {
    de: {
      ...
      copyright_text: "© 2025 BUNKERBANDITS. Alle Rechte vorbehalten. | Webdesign und Programmierung: Dennis Joest mit Unterstützung von KI.",

      imprint_title: "BunkerBandits - Impressum",
      legal_info: "Angaben gemäß § 5 DDG",
      represented_by: "Vertreten durch:",
      contact_info: "Kontaktinformationen",
      content_responsibility: "Verantwortlich für den Inhalt nach § 18 Abs. 2 MStV:",
    ...
    en: {
      ...
      content_responsibility: "Responsible for content according to § 18 Abs. 2 MStV:",
      ...
      google_adsense: "Google AdSense",
      google_adsense_text: "This website uses Google AdSense, a web advertising service provided by Google Inc., USA ('Google'). Google AdSense uses 'cookies' (text files) that are stored on your computer to analyze how you use the website. Google AdSense also uses 'web beacons' (small invisible graphics) to collect information. Through the use of web beacons, simple actions such as visitor traffic on the website can be recorded and collected. The information generated by the cookie and/or web beacon about your use of this website (including your IP address) will be transmitted to and stored by Google on servers in the United States. Google will use this information to evaluate your use of the website with regard to advertisements, to compile reports on website activity and advertisements for website operators, and to provide other services related to website and internet usage. Google may also transfer this information to third parties where required to do so by law, or where such third parties process the information on Google's behalf. Google will not associate your IP address with any other data held by Google. You can prevent the storage of cookies on your hard drive and the display of web beacons by selecting 'do not accept cookies' in your browser settings; however, please note that if you do this, you may not be able to use the full functionality of this website. By using this website, you consent to the processing of data about you by Google in the manner and for the purposes set out above."
    }
  ...
  function updateFlag(lang) {
    flagIcon.src =
      lang === "de" ? "assets/germany-flag-icon.svg" : "assets/uk_flag.svg";
    flagIcon.alt = lang === "de" ? "Deutsch" : "English";
    flagIcon.title = lang === "de" ? "Deutsch" : "English";
  }
